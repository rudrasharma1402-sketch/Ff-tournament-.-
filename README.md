...
<head>
    ...
    <title>Ultimate Free Fire Tournament 2025</title>
    <!-- Use Tailwind CSS for rapid styling -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Google Fonts for a bold, gaming-style font -->
    ...
    <style>
        ...
        .bangers-font {
            ...
            text-shadow: 2px 2px 0px #FFD700, 4px 4px 0px #FF8C00;
        }

        .card {
            background: #222;
            border: 2px solid #FF8C00;
            box-shadow: 0 0 20px rgba(255, 140, 0, 0.4), 0 0 10px rgba(255, 215, 0, 0.2);
        ...
        @keyframes pulse-glow {
            0%, 100% { box-shadow: 0 0 10px rgba(255, 140, 0, 0.6), 0 0 20px rgba(255, 215, 0, 0.4); }
            50% { box-shadow: 0 0 20px rgba(255, 140, 0, 0.8), 0 0 40px rgba(255, 215, 0, 0.6); }
        }
